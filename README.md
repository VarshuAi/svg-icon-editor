...
<div align="center">
<br>
[![Repo Stats](https://github-readme-stats.vercel.app/api/pin/?username=VarshuAi&repo=svg-icon-editor&theme=dark&bg_color=000000&title_color=00FF88&icon_color=00FF88&text_color=00CC66)](https://github.com/VarshuAi/svg-icon-editor)
<br>
</div>
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/svg-icon-editor.git
   cd svg-icon-editor
   ```
...
[![Repo](https://img.shields.io/badge/svg-icon-editor-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/svg-icon-editor)
